 ...
 *
 * @package   GitHub_Gist_Quick_Link_Embed
 ...
 *
 * @wordpress-plugin
 * Plugin Name: GitHub Gist Quick Link Embed
 * Plugin URI: http://mitchmccline.com
 * Version: 1.0.0
 * Author: Mitch McCline
 * Description: Easily Include Gist Embeds on your WordPress Blog by pasting a link to the gist found on GitHub.
 * Author URI: http://mitchmccline.com
 * Text Domain: github-gist-quick-link-embed
 * License:           GPL-2.0+
 ...
 *----------------------------------------------------------------------------*/
require_once( plugin_dir_path( __FILE__ ) . 'public/class-gist-quick-link-embed.php' );

/*----------------------------------------------------------------------------*
 * Get instance of the class once plugins are loaded.
 *----------------------------------------------------------------------------*/
add_action( 'plugins_loaded', array( 'GitHub_Gist_Quick_Link_Embed', 'get_instance' ) );
